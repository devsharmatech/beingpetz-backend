            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="page-title mb-0">Create New Events</h1>
                        </div>
                        <div>
                            <a href="{{ route('admin.events.list') }}" class="btn btn-light">
                    ...
                    <div class="card-body">
                        ...
                        <form id="EventsForm" action="{{ route('admin.events.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-section">
                                            ...
                                            <select class="form-control @error('category_id') is-invalid @enderror"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ old('category_id', $Events->category_id ?? '') == $category->id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <!-- Title Field -->
                                        <div class="mb-4">
                                            <label for="title" class="form-label required">Events Title</label>
                                            <input type="text"
                                                class="form-control form-control @error('title') is-invalid @enderror"
                                                id="title" name="title" placeholder="Enter an engaging Events title"
                                        ...
                                        <div class="mb-4">
                                            <label for="description" class="form-label required">Events Description</label>
                                            <textarea id="description" name="description" rows="5" placeholder="write Events Description"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="location" placeholder="Enter the event location"
                                                value="{{ old('location') }}">
                                            @error('location')
                                                <div class="error-message">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i> Save Events
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.summernote').summernote({
                height: 300,
                placeholder: 'Write your Events content here...',
                toolbar: [
                    ['style', ['style']],
