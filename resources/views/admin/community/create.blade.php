            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h1 class="page-title mb-0">Create New Community</h1>
                    ...
                    <div class="card-body">
                        ...
                        <form id="communityForm" action="{{ route('admin.community.store') }}" method="POST"
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-control @error('type') is-invalid @enderror" id="type"
                                            ...
                                            <option value="public" {{ old('type') == 'public' ? 'selected' : '' }}>Public
                                            </option>
                                            <option value="private" {{ old('type') == 'private' ? 'selected' : '' }}>Private
                                            </option>
                                        </select>
                                        @error('type')
                                            <div class="invalid-feedback">{{ $message }}</div>
