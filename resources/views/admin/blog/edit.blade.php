                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_description"
                                                name="short_description" rows="4" placeholder="Write a compelling description that summarizes your blog post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="url"
                                                        ...
                                                        value="{{ old('author_link', $blog->author_link) }}">
                                                    <div class="form-text">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="content" name="content" rows="5" class="form-control @error('content') is-invalid @enderror">{{ old('content', $blog->content) }}</textarea>
                                            @error('content')
                                                <div class="error-message">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        @if ($blog->image)
                                            <div class="mb-3">
                                                ...
                                                <img src="{{ asset($blog->image) }}" alt="Current Featured Image"
                                                    class="current-image">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#resetBtn').on('click', function() {
                ...
                $('#author_link').val('{{ $blog->author_link }}');
                $('#published_at').val(
                    '{{ $blog->published_at ? $blog->published_at->format('Y-m-d\TH:i') : '' }}');
